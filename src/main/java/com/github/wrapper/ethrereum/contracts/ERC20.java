...
public class ERC20 extends Contract {
    ...
    private static final String FUNC_TOTALSUPPLY = "totalSupply";

    private static final String FUNC_TRANSFERFROM = "transferFrom";

    private static final String FUNC__TOTALSUPPLY = "_totalSupply";

    private static final String FUNC_BALANCEOF = "balanceOf";

    private static final String FUNC_TRANSFER = "transfer";

    private static final String FUNC_ALLOWANCE = "allowance";

    private static final Event APPROVAL_EVENT = new Event("Approval",
    ...
    public RemoteCall<BigInteger> totalSupplyOne() {
    ...
    public RemoteCall<BigInteger> balanceOf(String who) {
        final Function function = new Function(FUNC_BALANCEOF,
                Arrays.asList(new org.web3j.abi.datatypes.Address(who)),
                Arrays.asList(new TypeReference<Uint256>() {
                }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public Flowable<ApprovalEventResponse> approvalEventObservable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ApprovalEventResponse>() {
            @Override
            public ApprovalEventResponse apply(@NotNull Log log) throws Exception {
    ...
    public Flowable<TransferEventResponse> transferEventObservable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TransferEventResponse>() {
            @Override
            public TransferEventResponse apply(@NotNull Log log) throws Exception {
